...
defined('_JEXEC') or die;
 ...
 // if vimeo output the video id
    ...
    // Loading the javascript and css
         JHtml::_('stylesheet', 'mod_btvideo/lite-vimeo-embed.min.css', array('version' => 'auto', 'relative' => true));
         JHtml::_('script', 'mod_btvideo/lite-vimeo-embed.min.js', array('version' => 'auto', 'relative' => true), array('defer' => 'defer'));
    ...
    // else if youtube output the video id
        ...
        // Loading the javascript and css
        JHtml::_('stylesheet', 'mod_btvideo/lite-yt-embed.css', array('version' => 'auto', 'relative' => true));
        JHtml::_('script', 'mod_btvideo/lite-yt-embed.js', array('version' => 'auto', 'relative' => true), array('defer' => 'defer'));
        ?>
